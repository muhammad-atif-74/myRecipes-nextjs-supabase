...
import PreviewRecipe from '@/app/components/modals/PreviewRecipe'
...
const AddRecipePage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const result = await uploadFile(formData.image, "images");

            console.log(result, "THIS IS RESULT OF FILE UPLOAD")
            if (!result.success) {
    ...
    return (
        <>
            ...
            <PreviewRecipe
                ...
                recipeData={{...formData, imagePreview: imagePreview}}
            />
        </>
    )
}
